...
@NotThreadSafe
public class RedisClusterPipeLineClient extends PipelineBase implements Closeable  {




    private static final Logger LOGGER = LoggerFactory.getLogger(RedisClusterPipeLineClient.class);
     ...
     * @return
     */
    public static RedisClusterPipeLineClient pipelined(JedisCluster jedisCluster) {
        RedisClusterPipeLineClient pipeline = new RedisClusterPipeLineClient();
    ...
    //每次执行命令(如 set get等都会，调用此方法，放入clients的list中)
    @Override
    ...
    public static void main(String[] args) throws IOException {
        ...
        RedisClusterPipeLineClient jcp = RedisClusterPipeLineClient.pipelined(jc);
        jcp.refreshCluster();
