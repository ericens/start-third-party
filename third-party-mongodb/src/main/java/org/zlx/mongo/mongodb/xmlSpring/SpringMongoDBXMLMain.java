...
public class SpringMongoDBXMLMain {
	...
	public static void main(String[] args) {
		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("mongodb/anotation/spring.xml");
		
//		ClassPathXmlApplicationContext ctx = new ClassPathXmlApplicationContext("mongodb/xmlSpring/spring.xml");
